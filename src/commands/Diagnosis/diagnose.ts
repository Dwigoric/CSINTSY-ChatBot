...
export class DiagnoseCommand extends Command {
                ...
                builder
                    ...
                    .addIntegerOption((option) =>
                        option
                            .setName("age")
                            .setDescription(
                                "The age of the patient to diagnose."
                            )
                            .setRequired(true)
                            .setMinValue(0)
                            .setMaxValue(122)
                    ...
                    .addStringOption((option) =>
                        option
                            ...
                            .setDescription(
                                "The biological sex of the patient to diagnose."
                            )
                            .setRequired(true)
                            .setChoices(
                                { name: "M", value: "M" },
                    ...
                    .addNumberOption((option) =>
                        option
                            .setName("height")
                            .setDescription(
                                "The height of the patient to diagnose (in centimeters)."
                            )
                            .setRequired(true)
                            .setMinValue(0)
                            .setMaxValue(272)
                    ...
                    .addNumberOption((option) =>
                        option
                            .setName("weight")
                            .setDescription(
                                "The weight of the patient to diagnose (in kilograms)."
                            )
                            .setRequired(true)
                            .setMinValue(0)
                            .setMaxValue(635)
                    ...
                    .addIntegerOption((option) =>
                        option
                            ...
                            .setDescription(
                                "If blood pressure (BP) is 120/80, then the systolic BP is 120."
                            )
                            .setRequired(true)
                            .setMinValue(120)
                            .setMaxValue(370)
                    ...
                    .addIntegerOption((option) =>
                        option
                            ...
                            .setDescription(
                                "If blood pressure (BP) is 120/80, then the diastolic BP is 80."
                            )
                            .setRequired(true)
                            .setMinValue(30)
                            .setMaxValue(360)
                    ...
                    .addBooleanOption((option) =>
                        option
                            .setName("smoking")
                            .setDescription(
                                "Whether the patient to diagnose smokes."
                            )
                            .setRequired(true)
                    );
            },
    ...
    private async handleExistingSession(
        ...
        return interaction.reply({
            content:
                "You already have an active session. Would you like to delete it?",
            components: [actionRow],
            ephemeral: true,
        });
    }
